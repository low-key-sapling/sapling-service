package net.zf.module.system.infrastructure.common.utils.redis;
...
@Component
public class RedisHashHelper<HK, HV> extends RedisCommonHelper {
     ...
     */
    public Boolean hPutIfAbsent(String key, HK hashKey, HV value) {
