package net.zf.module.system.client.components.rc;

import com.dtflys.forest.annotation.*;
import net.zf.module.system.client.components.rc.interceptors.RequestSignInterceptor;
import net.zf.module.system.client.components.rc.interceptors.ServiceDiscoveryInterceptor;
