package net.zfsy.framework.common.exception.util;

import com.google.common.annotations.VisibleForTesting;
import lombok.extern.slf4j.Slf4j;
import net.zfsy.framework.common.exception.ErrorCode;
import net.zfsy.framework.common.exception.ServiceException;
 ...
 *
 * 1. 异常提示信息，写在枚举类中，例如说，cn.endpoint.oceans.user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
...
public class ServiceExceptionUtil {
    ...
    public static ServiceException exception(ErrorCode errorCode) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getType(), errorCode.getMessage());
        return exception0(errorCode.getType(), messagePattern);
    }

    public static ServiceException exception(ErrorCode errorCode, Object... params) {
        String messagePattern = MESSAGES.getOrDefault(errorCode.getType(), errorCode.getMessage());
        return exception0(errorCode.getType(), messagePattern, params);
    }
