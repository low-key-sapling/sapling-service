...
public class FileSystemUtils {
    ...
    public static long getUsableSpace(String path) {
        try {
            ...
            throw new BasicException(AppHttpStatus.IO_EXCEPTION.getStatus(), "获取此抽象路径名指定的分区上可用于此虚拟机的字节数异常，" + e);
        }
    }
    ...
    public static long getUnallocatedSpace(String path) {
        try {
            ...
            throw new BasicException(AppHttpStatus.IO_EXCEPTION.getStatus(), "获取文件系统中未分配存储空间的字节数异常，" + e);
        }
    }
    ...
    public static long getTotalSpace(String path) {
        try {
            ...
            throw new BasicException(AppHttpStatus.IO_EXCEPTION.getStatus(), "获取文件系统对应的总的字节数异常，" + e);
        }
    }
    ...
    public static boolean isReadOnly(String path) {
        try {
            ...
            throw new BasicException(AppHttpStatus.IO_EXCEPTION.getStatus(), "判断文件存储是否只读异常，" + e);
        }
    }
}
